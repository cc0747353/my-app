                    ...
                    <div class="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
                        ...
                        <div class="offcanvas-body ms-lg-auto d-flex flex-column h-100">
                            <ul class="navbar-nav">
                                ...
                                {{-- create an array of frontend links and set the data for the routes in the arays go to the routes/web.php file--}}
                                @php
                                    $frontendLinks = [
                                        ['name' => 'Home', 'route' => route('home')],
                                        ['name' => 'About Us', 'route' => route('about')],
                                        ['name' => 'Services', 'route' => route('services')],
                                        ['name' => 'Accounts', 'route' => route('accounts')],
                                        ['name' => 'Loans', 'route' => route('loans')],
                                        ['name' => 'Credit Cards', 'route' => route('credit-cards')],
                                        ['name' => 'Online Banking', 'route' => route('online-banking')],
                                        ['name' => 'Mobile Banking', 'route' => route('mobile-banking')],
                                        ['name' => 'Customer Support', 'route' => route('customer-support')],
                                        ['name' => 'Contact Us', 'route' => route('contact')],
                                        ['name' => 'Privacy Policy', 'route' => route('privacy-policy')],
                                        ['name' => 'Terms and Conditions', 'route' => route('terms-and-conditions')],
                                    ];
                                @endphp
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    {{-- if the user is authenicated show this nav item --}}
                                    @auth
                                        <li class="nav-item">
                                    ...
                                    {{-- if the user is not authenicated show this nav item --}}
                                    @guest
                                        <li class="nav-item">
