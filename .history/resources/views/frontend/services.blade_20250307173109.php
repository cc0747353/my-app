<x-frontend.app>
    ...
    <section class="wrapper bg-light angled upper-end">
        <div class="container pb-14 pb-md-16">
            ...
            <p class="lead fs-lg mb-8">We make your spending <span class="underline">stress-free</span> for you to have
                the perfect control.</p>
        ...
        <div class="container py-18 text-center">
            <div class="row">
                <div class="col-lg-10 col-xl-10 col-xxl-8 mx-auto">
                    ...
                    <h2 class="display-4 px-lg-10 px-xl-13 px-xxl-10 mb-10 text-white">Find out everything you need to
                        know about creating a business process model.</h2>
                </div>
                <!--/column -->
            </div>
            <!--/.row -->
        ...
        <div class="container py-14 py-md-16">
            <div class="row gx-lg-8 gx-xl-12 gy-6 mb-10 mb-md-18">
                <div class="col-lg-4">
                    ...
                    <p>Enjoy a <a href="#" class="hover">free 30-day trial</a> and experience the full service.
