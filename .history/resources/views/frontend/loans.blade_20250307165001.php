        ...
        <div class="container pt-10 pb-19 pt-md-14 pb-md-20 text-center">
            <div class="row">
                <div class="col-md-7 col-lg-6 col-xl-5 mx-auto">
                    ...
                    <p class="lead px-lg-5 px-xxl-8">Welcome to our journal. Here you can find the latest company news
                        and business articles.</p>
                </div>
                <!-- /column -->
            </div>
            <!-- /.row -->
                        ...
                        <article class="post">
                            <div class="card">
                                <figure class="card-img-top overlay overlay-1 hover-scale"><a class="link-dark"
                                        href="blog-post.html"><img src="assets/img/photos/b1.jpg"
                                            alt="" /></a>
                                    <figcaption>
                                ...
                                <div class="card-body">
                                    <div class="post-header">
                                        ...
                                        <h2 class="post-title mt-1 mb-0"><a class="link-dark"
                                                href="blog-post.html">Amet Dolor Bibendum Parturient Cursus</a></h2>
                                    </div>
                                    <!-- /.post-header -->
                                    <div class="post-content">
                                        <p>Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia
                                            ...
                                            cursus commodo, tortor mauris condimentum nibh. Cras mattis consectetur
                                            purus sit amet fermentum. Sed posuere consectetur.</p>
                                    </div>
                                    <!-- /.post-content -->
                                </div>
                                <!--/.card-body -->
                                    ...
                                    <div class="swiper-container dots-over" data-margin="5" data-nav="true"
                                        ...
                                        <div class="swiper">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide"><img src="assets/img/photos/b2.jpg"
                                                        alt="" /></div>
                                                <div class="swiper-slide"><img src="assets/img/photos/b3.jpg"
                                                        alt="" /></div>
                                            </div>
                                            <!--/.swiper-wrapper -->
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="post-header">
                                        ...
                                        <!-- /.post-category -->
                                        <h2 class="post-title mt-1 mb-0"><a class="link-dark"
                                                href="blog-post.html">Consectetur Bibendum Sollicitudin Vulputate</a>
                                        </h2>
                                    </div>
                                    <!-- /.post-header -->
                                    <div class="post-content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="post-content">
                                            <p>Mauris convallis non ligula non interdum. Gravida vulputate convallis
                                                tempus vestibulum cras imperdiet nun eu dolor. Aenean lacinia bibendum
                                                nulla sed.</p>
                                        </div>
                                        <!-- /.post-content -->
                                    </div>
